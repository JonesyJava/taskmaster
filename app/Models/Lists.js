...
export default class List{
    ...
    get Template(){
        return /*html*/`
        <div class="col-3 card container-fluid border-dark my-4 mx-5" style="background-color: ${this.BGcolor}">  
            ...
            <div class="justify-content-center text-center">
                ...
                <form onsubmit="app.tasksController.create(event, '${this.id}')">
                    <div class="form-group">
                        <input class="form-control text-center" type="text" name="title" placeholder="What would you like to get done today?" pattern=".{3,15}" required>
